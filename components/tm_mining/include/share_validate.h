...
// Use this after share_validate() returns SHARE_VALID on the HW-SHA path to
// catch classic-ESP32 DPORT partial-corruption where a corrupt HW hash
// passes the target compare but disagrees with a SW recompute.
