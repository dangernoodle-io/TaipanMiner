...
void test_valid_hostname_single_char(void)
{
    ...
    TEST_ASSERT_EQUAL(0, config_set_hostname("a"));
    TEST_ASSERT_EQUAL_STRING("a", config_hostname());
}
...
void test_valid_hostname_lowercase_digits_hyphen(void)
{
    bb_nv_config_init();
    config_init();
    TEST_ASSERT_EQUAL(0, config_set_hostname("abc-def"));
    TEST_ASSERT_EQUAL_STRING("abc-def", config_hostname());
}
...
void test_valid_hostname_mixed(void)
{
    bb_nv_config_init();
    config_init();
    TEST_ASSERT_EQUAL(0, config_set_hostname("tdongles3-1"));
    TEST_ASSERT_EQUAL_STRING("tdongles3-1", config_hostname());
}
...
void test_valid_hostname_max_length(void)
{
    ...
    hostname[32] = '\0';
    TEST_ASSERT_EQUAL(0, config_set_hostname(hostname));
    TEST_ASSERT_EQUAL_STRING(hostname, config_hostname());
}
...
void test_invalid_hostname_empty(void)
{
    bb_nv_config_init();
    config_init();
    TEST_ASSERT_NOT_EQUAL(0, config_set_hostname(""));
}
...
void test_invalid_hostname_leading_hyphen(void)
{
    bb_nv_config_init();
    config_init();
    TEST_ASSERT_NOT_EQUAL(0, config_set_hostname("-leading"));
}
...
void test_invalid_hostname_underscore(void)
{
    bb_nv_config_init();
    config_init();
    TEST_ASSERT_NOT_EQUAL(0, config_set_hostname("with_underscore"));
}
...
void test_invalid_hostname_dot(void)
{
    bb_nv_config_init();
    config_init();
    TEST_ASSERT_NOT_EQUAL(0, config_set_hostname("with.dot"));
}
...
void test_invalid_hostname_too_long(void)
{
    ...
    hostname[33] = '\0';
    TEST_ASSERT_NOT_EQUAL(0, config_set_hostname(hostname));
}
...
void test_hostname_persists_after_set(void)
{
    ...
    TEST_ASSERT_EQUAL(0, config_set_hostname("miner-test-1"));
    // Read it back
    TEST_ASSERT_EQUAL_STRING("miner-test-1", config_hostname());
}
