...
bb_err_t config_register_manifest(void)
{
    static const bb_manifest_nv_t nv_keys[] = {
        ...
        },
        {
            ...
            .default_ = "0",
            .max_len = 0,
            .desc = "primary: send mining.extranonce.subscribe",
            .reboot_required = false,
            .provisioning_only = false,
        },
        {
            ...
            .default_ = "0",
            .max_len = 0,
            .desc = "fallback: send mining.extranonce.subscribe",
            .reboot_required = false,
            .provisioning_only = false,
        },
        {
            ...
            .default_ = "1",
            .max_len = 0,
            .desc = "primary: UI decodes coinbase tx",
            .reboot_required = false,
            .provisioning_only = false,
        },
        {
            ...
            .default_ = "1",
            .max_len = 0,
            .desc = "fallback: UI decodes coinbase tx",
            .reboot_required = false,
            .provisioning_only = false,
        },
    };
