...
/* ESP32-C3 SuperMini — headless SW-mining scaffold. Single-core; miner shares core 0.
 * 0.42" OLED (SSD1306 72x40) is a deferred follow-up once pinout is confirmed. */
