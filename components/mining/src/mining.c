...
//
// This file NEVER references bb_pub, bb_sink_*, bb_egress, bb_event,
// bb_cache, cJSON, or any transport/delivery API -- see mining_wire.c for
// the producer surface and src/main.c for where it is registered.
//
                                 ...
                                 bool *found_out)
{
     ...
     * (default n on classic ESP32 — see components/mining/Kconfig and
