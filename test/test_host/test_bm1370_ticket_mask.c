...
void test_bm1370_ticket_mask_diff_1(void) {
    ...
    bm1370_difficulty_to_mask(1.0, mask);
...
void test_bm1370_ticket_mask_diff_2(void) {
    ...
    bm1370_difficulty_to_mask(2.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_4(void) {
    ...
    bm1370_difficulty_to_mask(4.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_8(void) {
    ...
    bm1370_difficulty_to_mask(8.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_16(void) {
    ...
    bm1370_difficulty_to_mask(16.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_32(void) {
    ...
    bm1370_difficulty_to_mask(32.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_64(void) {
    ...
    bm1370_difficulty_to_mask(64.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_128(void) {
    ...
    bm1370_difficulty_to_mask(128.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_256(void) {
    ...
    bm1370_difficulty_to_mask(256.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_512(void) {
    ...
    bm1370_difficulty_to_mask(512.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_1024(void) {
    ...
    bm1370_difficulty_to_mask(1024.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_2048(void) {
    ...
    bm1370_difficulty_to_mask(2048.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_diff_4096(void) {
    ...
    bm1370_difficulty_to_mask(4096.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_non_power_of_2_700(void) {
    uint8_t mask[4];
    uint8_t expected[4] = {0x00, 0x00, 0x80, 0xFF};
    bm1370_difficulty_to_mask(700.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_non_power_of_2_513(void) {
    uint8_t mask[4];
    uint8_t expected[4] = {0x00, 0x00, 0x80, 0xFF};
    bm1370_difficulty_to_mask(513.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_non_power_of_2_1000(void) {
    uint8_t mask[4];
    uint8_t expected[4] = {0x00, 0x00, 0x80, 0xFF};
    bm1370_difficulty_to_mask(1000.0, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_below_1(void) {
    uint8_t mask[4];
    uint8_t expected[4] = {0x00, 0x00, 0x00, 0x00};
    bm1370_difficulty_to_mask(0.5, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_very_small(void) {
    uint8_t mask[4];
    uint8_t expected[4] = {0x00, 0x00, 0x00, 0x00};
    bm1370_difficulty_to_mask(0.001, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_boundary_513_5(void) {
    uint8_t mask[4];
    uint8_t expected[4] = {0x00, 0x00, 0x80, 0xFF};
    bm1370_difficulty_to_mask(513.5, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
...
void test_bm1370_ticket_mask_boundary_512_1(void) {
    uint8_t mask[4];
    uint8_t expected[4] = {0x00, 0x00, 0x80, 0xFF};
    bm1370_difficulty_to_mask(512.1, mask);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, mask, 4);
}
