...
//
// Inputs are uint32_t; the helpers do unsigned subtraction so a single
// wraparound is naturally correct. Callers pass ms already converted from
// whatever monotonic clock they use (see bb_timer_now_us()).
