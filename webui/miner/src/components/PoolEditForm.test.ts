...
describe('PoolEditForm', () => {
  ...
  it('shows Saving… when saving=true', () => {
    render(PoolEditForm, { props: { ...makeForm(), kind: 'Primary', saving: true } })
  ...
  it('shows saveMsg when provided', () => {
    render(PoolEditForm, { props: { ...makeForm(), kind: 'Primary', saveMsg: 'Pool saved' } })
