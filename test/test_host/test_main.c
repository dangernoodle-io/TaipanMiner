...
int main(void) {
    ...
    RUN_TEST(test_pool_stats_recovery_last_seen_us_small_value_preserved);
    RUN_TEST(test_pool_stats_recovery_last_seen_us_negative_reset);
    RUN_TEST(test_pool_stats_init_then_find_or_alloc_preserves_shares);
    ...
    RUN_TEST(test_knot_table_apply_txt_ui_zero);
    RUN_TEST(test_knot_table_apply_txt_ui_one);
    RUN_TEST(test_knot_table_apply_txt_ui_absent_defaults_true);
